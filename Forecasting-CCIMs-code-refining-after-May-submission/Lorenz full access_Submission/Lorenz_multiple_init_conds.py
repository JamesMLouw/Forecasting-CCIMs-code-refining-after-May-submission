...
if not(skip_les):
    ...
    np.save('LE convergence Lorenz access - ' + access,lorenz_esn_time)
     ...
     lorenz_esn_top_le = 0.9796 #for parameters on 8 April 2024 Monday
     # np.save('Top LE ESN Lorenz access - ' + access ,lorenz_esn_top_le)

#%%
print(lorenz_esn_top_le)

print(type(lorenz_esn_top_le))
print(type(lorenz_esn_time))
#%%
...
title = ''
esn_help.prediction_error_plot(z_errors, h, lorenz_esn_top_le,
plot_with_error_bound = True, log_scale = True, time_cut_off=14, N_transient=100,
title = title, include_title = True)
