...
np.save('Initial conditions rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' ',init_conds)
...
np.save('Training data rossler access - full system experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' ',training_datas)
np.save('Testing data rossler access - full system experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' ',testing_datas)
np.save('Time steps data rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' ',time_steps)
...
if access == '$x$ coordinate':
    ...
    np.save('Training data rossler access - ' + str(access) + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' ',training_datas)
    np.save('Testing data rossler access - ' + str(access) + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' ',testing_datas)
...
# save state_dicts
np.save('State dicts rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' ',state_dicts)
...
w, bias = reg_result
np.save('Regression result w rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type +' ',w)
np.save('Regression result bias rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type +' ',bias)
...
np.save('Predictions rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type +' ',predictions)
...
np.save('Average training error rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type +' ',av_training_error)
...
np.save('Average testing error rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type +' ',av_error)
...
if not(skip_les):
    ...
    np.save('Top LE ESN rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type +' ',rossler_esn_top_le)
    np.save('LE convergence rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type +' ',rossler_esn_time)
    
else:
     rossler_esn_top_le = 0.9125459202784676 #for parameters on 8 April 2024 Monday
     # np.save('Top LE ESN rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type +' ',rossler_esn_top_le)
...
init_conds = np.load('Initial conditions rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' .npy')
training_datas = np.load('Training data rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' .npy')
testing_datas =  np.load('Testing data rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' .npy')
time_steps =  np.load('Time steps data rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' .npy')
state_dicts = np.load('State dicts rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' .npy', allow_pickle = True)

w = np.load('Regression result w rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type + ' .npy')
bias = np.load('Regression result bias rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type + ' .npy')
reg_result = (w, bias)
predictions = np.load('Predictions rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type + ' .npy', allow_pickle = True)
av_training_error = np.load('Average training error rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type + ' .npy')
av_error = np.load('Average testing error rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type + ' .npy')
rossler_esn_top_le = np.load('Top LE ESN rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type + ' .npy')
rossler_esn_time = np.load('LE convergence rossler access - ' + access + ' experimenting - ' + str(experimenting) + ' trajectories - ' + str(N_init_cond) + ' type init conds  - ' + type_init_conds + ' sd - ' + str(sd) + ' training type - ' + training_type +' .npy')
